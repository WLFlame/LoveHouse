...
//void TTAlertEMError(EMError *error) {
//    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"提示" message:[NSString stringWithFormat:@"errorcode : %zd \ndescription : %@", error.errorCode, error.description ] delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
//    [alert show];
//}
...
void TTAlertError(NSError *error) {
    TTAlert([NSString stringWithFormat:@"code : %ld\ndomain : %@\nuserInfo : %@", (long)error.code, error.domain, error.userInfo]);
}
